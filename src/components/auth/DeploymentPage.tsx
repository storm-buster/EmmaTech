 ...
 *  endpoint (HttpOnly session cookie) — it is no longer a public static asset.
 *  The signed-in customer downloads it in the browser, then transfers it to the
 *  target Windows server and runs it. */
        ...
        {credential && (
          <>
            ...
            <Hint>
              ...
              through your authenticated EmmaTech session; no GitHub access is required. The
              enrollment token is never part of any command or URL.
            </Hint>
